...
df2 = df2.groupby('name', sort=False)[['quote.GBP.percent_change_1h','quote.GBP.percent_change_24h',
...
cat_plot.set(title='Categorical plots show the percentage of cryptos change through period of time', 
...
bar_plot = bar_plot.set(title='Bar chart indicates the percentage of cryptos change through period of time', 
             xlabel = 'Percent change', ylabel= '%')
